...
def extract_transform():
    ...
    felony_charge.to_csv('felony_charge.csv', index=False)
    pred_universe_fel_merge = pd.merge(pred_universe, felony_charge, on='arrest_id', how='left')
    pred_universe_fel_merge.to_csv('pred_universe_fel_merge.csv', index= False)
    ...
    charge_counts.to_csv('data/charge_counts.csv', index=False)
    charge_counts_by_offense.to_csv('data/charge_counts_by_offense.csv', index=False)
    
    return pred_universe, arrest_events, charge_counts, charge_counts_by_offense, felony_charge, pred_universe_fel_merge
